...
#1 en este caso creamos una función que nos traera el total de minutos que dura cada viaje, insertando el id del viaje. Se utiliza un calculo interno sin recurrir a otro cruce de tabla.
DELIMITER //
...
#2 En esta funcion personalizada se consigue el paradero actual de cada scooter que indiquemos a través de su scooter_id. En este caso reemplazamos el join con una subconsulta para poder traernos la estacion asignada al scooter.
...
#Stored Procedures
#3 En este stored procedure se ejecuta un ordenamiento de tabla, de forma de SQL Dinamico donde asignamos la funcion a la variable y le damos la instruccion.
...
#4 Stored procedures SQL estatico para agregar y eliminar registros en una tabla. En el ejemplo seria una estación de scooters.
